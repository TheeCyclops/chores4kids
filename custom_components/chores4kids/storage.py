    ...
    async def daily_rollover(self):
        ...
        for t in self.tasks:
            ...
            templates.append({
                ...
                "points": t.points,
                "description": t.description,
                "default_start_time": self._normalize_hhmm(getattr(t, "default_start_time", None)),
                "default_end_time": self._normalize_hhmm(getattr(t, "default_end_time", None)),
                ...
                if tpl_id and due_iso:
                    for target in targets:
                        ...
                        await self.add_task(
                            ...
                            assigned_to=target,
                            default_start_time=tpl.get("default_start_time"),
                            default_end_time=tpl.get("default_end_time"),
