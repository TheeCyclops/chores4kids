...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    async def svc_add_task(call: ServiceCall):
        await store.add_task(
            ...
            default_start_time=call.data.get("default_start_time"),
            default_end_time=call.data.get("default_end_time"),
            override_start_time=call.data.get("override_start_time"),
            override_end_time=call.data.get("override_end_time"),
